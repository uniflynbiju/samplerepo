...
<div class="main-content">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <form action="<?php echo base_url('Csvupload/insert_data') ?>" enctype="multipart/form-data" method="post" role="form">
           <div class="form-group mt-4 text-center">
            <label for="exampleInputFile" class="mb-2">
  ...
  <input type="file" name="file" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
            ...
            <small class="form-text text-muted">Choose a CSV or Excel File Import.</small>
            <button type="submit" class="btn btn-primary" name="submit" value="submit" style="margin-bottom: 20px;">Upload</button>
        </div>
